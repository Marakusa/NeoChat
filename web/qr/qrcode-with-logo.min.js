!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.QrCodeWithLogo = e() : t.QrCodeWithLogo = e()
}(window, function() {
    return n = {},
    o.m = r = [function(t, e) {
    ...
    , function(t, e, r) {
        ...
        function s(t, e) {
            var r;
            return u.TYPED_ARRAY_SUPPORT ? (r = new Uint8Array(e)).__proto__ = u.prototype : (null === (r = t) && (r = new u(e)),
            r.length = e),
            r
        }
        function f(t, e) {
        ...
        function o(t, e) {
            for (var r = e.length < 0 ? 0 : 0 | i(e.length), n = s(t, r), o = 0; o < r; o += 1)
                n[o] = 255 & e[o];
            return n
        }
        function h(t, e) {
        ...
        function c(t) {
            return u.isBuffer(t) ? t.length : "undefined" != typeof ArrayBuffer && "function" == typeof ArrayBuffer.isView && (ArrayBuffer.isView(t) || t instanceof ArrayBuffer) ? t.byteLength : ("string" != typeof t && (t = "" + t),
        ...
        u.prototype.write = function(t, e, r) {
            void 0 === e || void 0 === r && "string" == typeof e ? (r = this.length,
            e = 0) : isFinite(e) && (e |= 0,
            isFinite(r) ? r |= 0 : r = void 0);
            var n = this.length - e;
            if ((void 0 === r || n < r) && (r = n),
        ...
        u.prototype.fill = function(t, e, r) {
            var n;
            if ("string" == typeof t ? ("string" == typeof e ? (e = 0,
            r = this.length) : "string" == typeof r && (r = this.length),
            1 !== t.length || (n = t.charCodeAt(0)) < 256 && (t = n)) : "number" == typeof t && (t &= 255),
            e < 0 || this.length < e || this.length < r)
            ...
            "number" == typeof (t = t || 0))
                ...
                for (var o = u.isBuffer(t) ? t : new u(t), i = o.length, a = 0; a < r - e; ++a)
                    this[a + e] = o[a % i];
            return this
        }
        ,
    ...
    , function(t, e, r) {
        "use strict";
        e.__esModule = !0,
        e.isImageDom = e.isString = e.isFunction = e.promisify = void 0,
    ...
    , function(t, g) {
        ...
        g.qrToImageData = function(t, e, r) {
            for (var n = e.modules.size, o = e.modules.data, i = g.getScale(n, r), a = Math.floor((n + 2 * r.margin) * i), u = r.margin * i, s = [r.color.light, r.color.dark], f = 0; f < a; f++)
                for (var h = 0; h < a; h++) {
                    var c = 4 * (f * a + h)
                      , l = r.color.light;
                    u <= f && u <= h && f < a - u && h < a - u && (l = s[o[Math.floor((f - u) / i) * n + Math.floor((h - u) / i)] ? 1 : 0]),
                    t[c++] = l.r,
                    t[c++] = l.g,
                    t[c++] = l.b,
                    t[c] = l.a
    ...
    , function(t, e, r) {
            ...
            return n(this, void 0, void 0, function() {
                return o(this, function(t) {
                    ...
                    case 1:
                        ...
                        t.label = 2;
                    case 2:
                        return a.saveImage(this.option.image, e),
                        [2]
                    }
                })
            })
        ...
        u);
        function u(t) {
            this.ifCanvasDrawed = !1,
            this.ifImageCreated = !1,
            this.defaultOption = {
    ...
    , function(t, e, r) {
        ...
        e.renderQrCode = function(t) {
            var e = t.canvas
              ...
              , i = void 0 === t ? {} : t;
            return i.errorCorrectionLevel = i.errorCorrectionLevel || s(r),
            u(r, i).then(function(t) {
                return i.scale = 0 === o ? void 0 : o / t * 4,
                a(e, r, i)
            })
        }
        ;
    ...
    , function(t, e, r) {
        ...
        function i(n, o, i, a, e) {
            ...
            if (!t) {
                ...
                return 1 === r ? (i = o,
                o = a = void 0) : 2 !== r || o.getContext || (a = i,
                i = o,
                o = void 0),
            ...
            2 === r ? (e = i,
            i = o,
            o = a = void 0) : 3 === r && (o.getContext && void 0 === e ? (e = a,
            a = void 0) : (e = a,
            a = i,
            i = o,
            o = void 0));
        ...
        e.create = f.create,
        e.toCanvas = i.bind(null, n.render),
        e.toDataURL = i.bind(null, n.renderToDataURL),
        e.toString = i.bind(null, function(t, e, r) {
            return o.render(t, r)
        })
    }
    , function(t, e) {
    ...
    , function(t, e, r) {
        var A = r(2)
          ...
          , d = r(4);
        function v(t, e, r) {
            for (var n, o = t.size, i = s.getEncodedBits(e, r), a = 0; a < 15; a++)
                n = 1 == (i >> a & 1),
                a < 6 ? t.set(a, 8, n, !0) : a < 8 ? t.set(a + 1, 8, n, !0) : t.set(o - 15 + a, 8, n, !0),
                a < 8 ? t.set(8, o - a - 1, n, !0) : a < 9 ? t.set(8, 15 - a - 1 + 1, n, !0) : t.set(8, 15 - a - 1, n, !0);
            t.set(o - 8, 8, 1, !0)
        }
        function y(e, t, r) {
            var n = new a;
            ...
            for (n.getLengthInBits() + 4 <= r && n.put(0, 4); n.getLengthInBits() % 8 != 0; )
                n.putBit(0);
            for (var o = (r - n.getLengthInBits()) / 8, i = 0; i < o; i++)
                n.put(i % 2 ? 17 : 236, 8);
            return function(t, e, r) {
                ...
                var w, m, b = A.alloc(n), E = 0;
                for (w = 0; w < p; w++)
                    for (m = 0; m < i; m++)
                        w < l[m].length && (b[E++] = l[m][w]);
                for (w = 0; w < f; w++)
                    for (m = 0; m < i; m++)
                        b[E++] = g[m][w];
                return b
        ...
        function w(t, s, e, r) {
            ...
            if (d(t))
                ...
                var o, i = s;
                i || (o = p.rawSplit(t),
                i = l.getBestVersionForData(o, e)),
                n = p.fromString(t, i || 40)
            }
            t = l.getBestVersionForData(n, e);
            if (!t)
            ...
            t = new u(t);
            return function(t) {
                for (var e = t.size, r = h.getPositions(s), n = 0; n < r.length; n++)
                    for (var o = r[n][0], i = r[n][1], a = -1; a <= 7; a++)
                        if (!(o + a <= -1 || e <= o + a))
                            for (var u = -1; u <= 7; u++)
                                i + u <= -1 || e <= i + u || (0 <= a && a <= 6 && (0 === u || 6 === u) || 0 <= u && u <= 6 && (0 === a || 6 === a) || 2 <= a && a <= 4 && 2 <= u && u <= 4 ? t.set(o + a, i + u, !0, !0) : t.set(o + a, i + u, !1, !0))
            }(t),
            function(t) {
            ...
            function(t) {
                for (var e = f.getPositions(s), r = 0; r < e.length; r++)
                    for (var n = e[r][0], o = e[r][1], i = -2; i <= 2; i++)
                        for (var a = -2; a <= 2; a++)
                            -2 === i || 2 === i || -2 === a || 2 === a || 0 === i && 0 === a ? t.set(n + i, o + a, !0, !0) : t.set(n + i, o + a, !1, !0)
            }(t),
            v(t, e, 0),
            7 <= s && function(t) {
                for (var e, r, n, o = t.size, i = l.getEncodedBits(s), a = 0; a < 18; a++)
                    e = Math.floor(a / 3),
                    r = a % 3 + o - 8 - 3,
                    n = 1 == (i >> a & 1),
                    t.set(e, r, n, !0),
            ...
            isNaN(r) && (r = c.getBestMask(t, v.bind(null, t, e))),
            c.applyMask(r, t),
            v(t, e, r),
            {
                modules: t,
        ...
        e.create = function(t, e) {
            ...
            var r, n, o = i.M;
            return void 0 !== e && (o = i.from(e.errorCorrectionLevel, i.M),
            r = l.from(e.version),
    ...
    , function(t, a, e) {
        ...
        a.getRowColCoords = function(t) {
            if (1 === t)
                return [];
            for (var e = Math.floor(t / 7) + 2, t = i(t), r = 145 === t ? 26 : 2 * Math.ceil((t - 13) / (2 * e - 2)), n = [t - 7], o = 1; o < e - 1; o++)
                n[o] = n[o - 1] - r;
            return n.push(6),
            n.reverse()
        }
        ...
        a.getPositions = function(t) {
            for (var e = [], r = a.getRowColCoords(t), n = r.length, o = 0; o < n; o++)
                for (var i = 0; i < n; i++)
                    0 === o && 0 === i || 0 === o && i === n - 1 || o === n - 1 && 0 === i || e.push([r[o], r[i]]);
            return e
        }
    }
    , function(t, e, r) {
    ...
    , function(t, u) {
        ...
        u.getPenaltyN1 = function(t) {
            for (var e = t.size, r = 0, n = 0, o = 0, i = null, a = null, u = 0; u < e; u++) {
                i = a = null;
                for (var s = n = o = 0; s < e; s++) {
                    var f = t.get(u, s);
                    f === i ? n++ : (5 <= n && (r += h + (n - 5)),
                    i = f,
                    n = 1),
                    (f = t.get(s, u)) === a ? o++ : (5 <= o && (r += h + (o - 5)),
                    a = f,
                    o = 1)
                }
                5 <= n && (r += h + (n - 5)),
        ...
        u.applyMask = function(t, e) {
            for (var r = e.size, n = 0; n < r; n++)
                for (var o = 0; o < r; o++)
                    e.isReserved(o, n) || e.xor(o, n, function(t, e, r) {
                        switch (t) {
    ...
    , function(t, n, e) {
        var a = e(2)
          , u = e(23);
        n.mul = function(t, e) {
            for (var r = a.alloc(t.length + e.length - 1), n = 0; n < t.length; n++)
 ...
 */
            ...
            function e(t, e, r) {
                ...
                for (t = t || "utf8"; ; )
                    ...
                    case "base64":
                        return n = this,
                        i = r,
                        0 === (o = e) && i === n.length ? u.fromByteArray(n) : u.fromByteArray(n.slice(o, i));
                    case "ucs2":
                    case "ucs-2":
                    case "utf16le":
                    case "utf-16le":
            ...
            function d(t, e, r, n, o) {
                ...
                if ("number" == typeof e)
                    return e &= 255,
                    c.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? (o ? Uint8Array.prototype.indexOf : Uint8Array.prototype.lastIndexOf).call(t, e, r) : v(t, [e], r, n, o);
            ...
            function v(t, e, r, n, o) {
                ...
                if (o)
                    for (var f = -1, h = r; h < a; h++)
                        if (s(t, h) === s(e, -1 === f ? 0 : h - f)) {
                            if (-1 === f && (f = h),
                            h - f + 1 === u)
                                return f * i
                        } else
            ...
            function m(t, e, r) {
                r = Math.min(t.length, r);
                for (var n = [], o = e; o < r; ) {
                    var i, a, u, s, f = t[o], h = null, c = 239 < f ? 4 : 223 < f ? 3 : 191 < f ? 2 : 1;
                    if (o + c <= r)
                        switch (c) {
                        case 1:
                            f < 128 && (h = f);
                        ...
                        case 3:
                            i = t[o + 1],
                            a = t[o + 2],
                            128 == (192 & i) && 128 == (192 & a) && 2047 < (s = (15 & f) << 12 | (63 & i) << 6 | 63 & a) && (s < 55296 || 57343 < s) && (h = s);
                            break;
                        case 4:
                            i = t[o + 1],
                            a = t[o + 2],
                            u = t[o + 3],
                            128 == (192 & i) && 128 == (192 & a) && 128 == (192 & u) && 65535 < (s = (15 & f) << 18 | (63 & i) << 12 | (63 & a) << 6 | 63 & u) && s < 1114112 && (h = s)
                        }
                    null === h ? (h = 65533,
                    c = 1) : 65535 < h && (h -= 65536,
            ...
            c.alloc = function(t, e, r) {
                ...
                r = r,
                s(t = t),
                !(t <= 0) && void 0 !== e ? "string" == typeof r ? o(n, t).fill(e, r) : o(n, t).fill(e) : o(n, t);
                var n
            }
            ,
            ...
            c.prototype.compare = function(t, e, r, n, o) {
                ...
                if (this === t)
                    return 0;
                for (var i = (o >>>= 0) - (n >>>= 0), a = (r >>>= 0) - (e >>>= 0), u = Math.min(i, a), s = this.slice(n, o), f = t.slice(e, r), h = 0; h < u; ++h)
                    if (s[h] !== f[h]) {
                        i = s[h],
                        a = f[h];
                        break
            ...
            c.prototype.slice = function(t, e) {
                ...
                c.TYPED_ARRAY_SUPPORT)
                    ...
                    for (var n = e - t, o = new c(n,void 0), i = 0; i < n; ++i)
                        o[i] = this[i + t];
                return o
            }
            ,
            ...
            c.prototype.writeUIntLE = function(t, e, r, n) {
                ...
                e |= 0,
                r |= 0,
                n || A(this, t, e, r, Math.pow(2, 8 * r) - 1, 0);
                var o = 1
                  , i = 0;
            ...
            c.prototype.writeIntLE = function(t, e, r, n) {
                t = +t,
                e |= 0,
                n || A(this, t, e, r, (n = Math.pow(2, 8 * r - 1)) - 1, -n);
                var o = 0
                  , i = 1
                  , a = 0;
            ...
            c.prototype.writeInt32LE = function(t, e, r) {
                return t = +t,
                e |= 0,
                r || A(this, t, e, 4, 2147483647, -2147483648),
                c.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t,
                this[e + 1] = t >>> 8,
                this[e + 2] = t >>> 16,
            ...
            c.prototype.fill = function(t, e, r, n) {
                ...
                "number" == typeof (t = t || 0))
                    ...
                    for (var i = c.isBuffer(t) ? t : I(new c(t,n).toString()), a = i.length, u = 0; u < r - e; ++u)
                        this[u + e] = i[u % a];
                return this
            }
            ;
            ...
            function S(t) {
                return u.toByteArray(function(t) {
                    var e;
                    if ((t = ((e = t).trim ? e.trim() : e.replace(/^\s+|\s+$/g, "")).replace(C, "")).length < 2)
                        return "";
                    for (; t.length % 4 != 0; )
                        t += "=";
                    return t
    ...
    , function(t, e, r) {
        ...
        e.toByteArray = function(t) {
            var e, r, n = h(t), o = n[0], n = n[1], i = new f(function(t, e) {
                return 3 * (t + e) / 4 - e
            }(o, n)), a = 0, u = 0 < n ? o - 4 : o;
            for (r = 0; r < u; r += 4)
                ...
                i[a++] = e >> 8 & 255,
                i[a++] = 255 & e;
            2 === n && (e = s[t.charCodeAt(r)] << 2 | s[t.charCodeAt(r + 1)] >> 4,
            i[a++] = 255 & e);
            1 === n && (e = s[t.charCodeAt(r)] << 10 | s[t.charCodeAt(r + 1)] << 4 | s[t.charCodeAt(r + 2)] >> 2,
            i[a++] = e >> 8 & 255,
            i[a++] = 255 & e);
            return i
        }
        ...
        e.fromByteArray = function(t) {
            for (var e, r = t.length, n = r % 3, o = [], i = 0, a = r - n; i < a; i += 16383)
                o.push(function(t, e, r) {
                    ...
                    return o.join("")
                }(t, i, a < i + 16383 ? a : i + 16383));
            1 == n ? (e = t[r - 1],
            o.push(u[e >> 2] + u[e << 4 & 63] + "==")) : 2 == n && (e = (t[r - 2] << 8) + t[r - 1],
            o.push(u[e >> 10] + u[e >> 4 & 63] + u[e << 2 & 63] + "="));
            return o.join("")
        }
        ;
        for (var u = [], s = [], f = "undefined" != typeof Uint8Array ? Uint8Array : Array, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = 0, i = n.length; o < i; ++o)
            u[o] = n[o],
            s[n.charCodeAt(o)] = o;
        function h(t) {
            var e = t.length;
    ...
    , function(t, e) {
        ...
        e.read = function(t, e, r, n, o) {
            var i, a, u = 8 * o - n - 1, s = (1 << u) - 1, f = s >> 1, h = -7, c = r ? o - 1 : 0, l = r ? -1 : 1, r = t[e + c];
            for (c += l,
            i = r & (1 << -h) - 1,
            r >>= -h,
            h += u; 0 < h; i = 256 * i + t[e + c],
            c += l,
            h -= 8)
                ;
            for (a = i & (1 << -h) - 1,
            i >>= -h,
            h += n; 0 < h; a = 256 * a + t[e + c],
            c += l,
            h -= 8)
                ;
            if (0 === i)
        ...
        e.write = function(t, e, r, n, o, i) {
            var a, u, s = 8 * i - o - 1, f = (1 << s) - 1, h = f >> 1, c = 23 === o ? Math.pow(2, -24) - Math.pow(2, -77) : 0, l = n ? 0 : i - 1, g = n ? 1 : -1, i = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
            for (e = Math.abs(e),
            isNaN(e) || e === 1 / 0 ? (u = isNaN(e) ? 1 : 0,
            a = f) : (a = Math.floor(Math.log(e) / Math.LN2),
            e * (n = Math.pow(2, -a)) < 1 && (a--,
            n *= 2),
            2 <= (e += 1 <= a + h ? c / n : c * Math.pow(2, 1 - h)) * n && (a++,
            n /= 2),
            f <= a + h ? (u = 0,
            a = f) : 1 <= a + h ? (u = (e * n - 1) * Math.pow(2, o),
            a += h) : (u = e * Math.pow(2, h - 1) * Math.pow(2, o),
            a = 0)); 8 <= o; t[r + l] = 255 & u,
            l += g,
            u /= 256,
            o -= 8)
    ...
    , function(t, o, e) {
        ...
        o.getBestVersionForData = function(t, e) {
            ...
            return function(t, e, r) {
                for (var n = 1; n <= 40; n++)
                    if (e <= o.getCapacity(n, r, t))
                        return n
            }(r.mode, r.getLength(), e)
        }
        ,
    ...
    , function(t, e, r) {
        ...
        e.getEncodedBits = function(t, e) {
            for (var e = t.bit << 3 | e, r = e << 10; 0 <= n.getBCHDigit(r) - o; )
                r ^= 1335 << n.getBCHDigit(r) - o;
            return 21522 ^ (e << 10 | r)
        }
    }
    , function(t, a, e) {
        ...
        function p(t) {
            var e, r = l(s.NUMERIC, g.NUMERIC, t), n = l(s.ALPHANUMERIC, g.ALPHANUMERIC, t), t = f.isKanjiModeEnabled() ? (e = l(s.BYTE, g.BYTE, t),
            l(s.KANJI, g.KANJI, t)) : (e = l(s.BYTE_KANJI, g.BYTE, t),
            []);
            return r.concat(n, e, t).sort(function(t, e) {
        ...
        function r(t, e) {
            var r = g.getBestModeForData(t)
              , e = g.from(e, r);
            if (e !== g.BYTE && e.bit < r.bit)
                throw new Error('"' + t + '" cannot be encoded with mode ' + g.toString(e) + ".\n Suggested mode is: " + g.toString(r));
            switch (e !== g.KANJI || f.isKanjiModeEnabled() || (e = g.BYTE),
            e) {
            case g.NUMERIC:
                return new n(t);
            case g.ALPHANUMERIC:
        ...
        a.fromArray = function(t) {
            return t.reduce(function(t, e) {
                return "string" == typeof e ? t.push(r(e, null)) : e.data && t.push(r(e.data, e.mode)),
                t
            }, [])
        }
        ,
        a.fromString = function(t, e) {
            for (var r = function(t, e) {
                for (var r = {}, n = {
                    ...
                    for (var a = t[i], u = [], s = 0; s < a.length; s++) {
                        ...
                        for (var c = 0; c < o.length; c++) {
                            var l = o[c];
                            r[l] && r[l].node.mode === f.mode ? (n[l][h] = d(r[l].lastCount + f.length, f.mode) - d(r[l].lastCount, f.mode),
                            r[l].lastCount += f.length) : (r[l] && (r[l].lastCount = f.length),
                            n[l][h] = d(f.length, f.mode) + 4 + g.getCharCountIndicator(f.mode, e))
                        }
                    }
                    o = u
                }
                ...
                return e
            }(p(t, f.isKanjiModeEnabled())), e), n = h.find_path(r.map, "start", "end"), o = [], i = 1; i < n.length - 1; i++)
                o.push(r.table[n[i]].node);
            return a.fromArray(o.reduce(function(t, e) {
                var r = 0 <= t.length - 1 ? t[t.length - 1] : null;
                return r && r.mode === e.mode ? t[t.length - 1].data += e.data : t.push(e),
                t
            }, []))
        }
        ,
        a.rawSplit = function(t) {
            return a.fromArray(p(t, f.isKanjiModeEnabled()))
        }
    }
    , function(t, e, r) {
        var n = r(1);
        ...
        o.prototype.write = function(t) {
            for (var e, r, n = 0; n + 3 <= this.data.length; n += 3)
                e = this.data.substr(n, 3),
                r = parseInt(e, 10),
                t.put(r, 10);
            var o = this.data.length - n;
            0 < o && (e = this.data.substr(n),
            r = parseInt(e, 10),
            t.put(r, 3 * o + 1))
        }
        ,
        ...
        var g = {
            single_source_shortest_paths: function(t, e, r) {
                var n = {}
                  , o = {};
                o[e] = 0;
                var i, a, u, s, f, h, c, l = g.PriorityQueue.make();
                for (l.push(e, 0); !l.empty(); )
                    for (u in a = (i = l.pop()).value,
                    s = i.cost,
                    f = t[a] || {})
                        f.hasOwnProperty(u) && (h = s + f[u],
                        c = o[u],
                        (void 0 === o[u] || h < c) && (o[u] = h,
                        l.push(u, h),
                        n[u] = a));
                if (void 0 === r || void 0 !== o[r])
                    return n;
                r = ["Could not find a path from ", e, " to ", r, "."].join("");
                throw new Error(r)
            },
            ...
            find_path: function(t, e, r) {
                e = g.single_source_shortest_paths(t, e, r);
                return g.extract_shortest_path_from_predecessor_list(e, r)
            },
            PriorityQueue: {
                make: function(t) {
                    var e, r = g.PriorityQueue, n = {};
                    for (e in t = t || {},
                    r)
                        r.hasOwnProperty(e) && (n[e] = r[e]);
                    return n.queue = [],
                    n.sorter = t.sorter || r.default_sorter,
                    n
                },
    ...
    , function(t, n, e) {
        ...
        n.render = function(t, e, r) {
            ...
            n = a.getOptions(n);
            var i = a.getImageWidth(t.modules.size, n)
              , r = o.getContext("2d")
              , e = r.createImageData(i, i);
            return a.qrToImageData(e.data, t, n),
            n = o,
            i = i,
        ...
        n.renderToDataURL = function(t, e, r) {
            ...
            e = r.type || "image/png",
            r = r.rendererOpts || {};
            return t.toDataURL(e, r.quality)
        }
    }
    , function(t, e, r) {
        var a = r(10);
        function u(t, e) {
            var r = t.a / 255
              , t = e + '="' + t.hex + '"';
            return r < 1 ? t + " " + e + '-opacity="' + r.toFixed(2).slice(1) + '"' : t
        }
        function h(t, e, r) {
            e = t + e;
            return void 0 !== r && (e += " " + r),
        ...
        e.render = function(t, e, r) {
            var n = a.getOptions(e)
              , o = t.modules.size
              , i = t.modules.data
              , e = o + 2 * n.margin
              , t = n.color.light.a ? "<path " + u(n.color.light, "fill") + ' d="M0 0h' + e + "v" + e + 'H0z"/>' : ""
              , o = "<path " + u(n.color.dark, "stroke") + ' d="' + function(t, e, r) {
                for (var n = "", o = 0, i = !1, a = 0, u = 0; u < t.length; u++) {
                    var s = Math.floor(u % e)
                      , f = Math.floor(u / e);
                    s || i || (i = !0),
                    t[u] ? (a++,
                    0 < u && 0 < s && t[u - 1] || (n += i ? h("M", s + r, .5 + f + r) : h("m", o, 0),
                    o = 0,
                    i = !1),
                    s + 1 < e && t[u + 1] || (n += h("h", a),
                    a = 0)) : o++
              ...
              , e = 'viewBox="0 0 ' + e + " " + e + '"'
              , o = '<svg xmlns="http://www.w3.org/2000/svg" ' + (n.width ? 'width="' + n.width + '" height="' + n.width + '" ' : "") + e + ' shape-rendering="crispEdges">' + t + o + "</svg>\n";
            return "function" == typeof r && r(null, o),
            o
        }
    }
    , function(t, e, r) {
        ...
        e.drawLogo = function(t) {
            ...
            l.fill();
            var g = new Image;
            g.setAttribute("crossOrigin", u || "anonymous"),
            g.src = s;
            return new Promise(function(r) {
                g.onload = function() {
                    var t, e;
                    f ? (t = g,
                    (e = document.createElement("canvas")).width = c + h,
                    e.height = c + h,
                    e.getContext("2d").drawImage(t, c, c, h, h),
                    d(l)(c, c, h, h, f),
                    l.fillStyle = l.createPattern(e, "no-repeat"),
                    l.fill()) : (e = g,
                    l.drawImage(e, c, c, h, h)),
                    r()
                }
            }
            )
    ...
    , function(t, a, e) {
        "use strict";
        var r = this && this.__awaiter || function(t, a, u, s) {
            return new (u = u || Promise)(function(r, e) {
                function n(t) {
                    try {
                        i(s.next(t))
        ...
        ;
        a.__esModule = !0,
        a.saveImage = a.toImage = void 0;
        var s = e(6)
          , f = e(3);
        a.toImage = function(i) {
            return r(this, void 0, void 0, function() {
                ...
                return u(this, function(t) {
                    ...
                    case 0:
                        return o = i.canvas,
                        i.logo && (f.isString(i.logo) && (i.logo = {
                            src: i.logo
                        }),
                        i.logo.crossOrigin = "Anonymous"),
                        this.ifCanvasDrawed ? [3, 2] : [4, s.toCanvas(i)];
                    case 1:
                        t.sent(),
                        t.label = 2;
                    case 2:
                        if (n = i.image,
                        e = void 0 === n ? new Image : n,
                        n = i.downloadName,
                        r = void 0 === n ? "qr-code" : n,
                        n = i.download,
                        !o.toDataURL())
                            throw new Error("Can not get the canvas DataURL");
                        return (e.src = o.toDataURL(),
                        (this.ifImageCreated = !0) === n || f.isFunction(n)) ? (o = function() {
                            a.saveImage(e, r)
                        }
                        ,
                        (n = !0 === n ? function(t) {
    ...
    , function(t) {
        t.exports = {
            ...
            umd: "lib/qrcode-with-logos.js",
            jsdelivr: "doc/qrcode-with-logos.min.js",
            unpkg: "doc/qrcode-with-logos.min.js",
            ...
            keywords: ["qr-code", "logo", "image", "qrCode", "size"],
            repository: {
                type: "git",
